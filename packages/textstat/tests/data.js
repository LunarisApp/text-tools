...
exports.testSyllableCountCases = exports.hardArabicText = exports.easyArabicText = exports.italianText = exports.longRussianTextGuillemets = exports.easySpanishText = exports.longSpanishText = exports.longTest = exports.punctTextResultWoApostr = exports.punctTextResultWApostr = exports.punctText = exports.shortTest = exports.difficultWord = exports.easyWord = exports.emptyStr = void 0;
exports.emptyStr = "";
exports.easyWord = "Dog";
exports.difficultWord = "Regardless";
exports.shortTest = "Cool dogs wear da sunglasses.";
exports.punctText = `I said: 'This is a test sentence to test the remove_punctuation function.
...
exports.punctTextResultWApostr = `I said This is a test sentence to test the remove_punctuation function
It's short and not the work of a singersongwriter But it'll suffice
Your answer was I don't know If I were you I'd write a test just to make
sure you're really just removing the characters you want to remove Didn't`;
exports.punctTextResultWoApostr = `I said This is a test sentence to test the remove_punctuation function
...
exports.longTest = "Playing ... games has always been thought to be " +
    ...
    "lives";
exports.longSpanishText = "Muchos años después, frente al pelotón de fusilamiento, " +
...
exports.easySpanishText = "Hoy es un lindo día";
exports.longRussianTextGuillemets = "Игра ... игры всегда считались важными для развития " +
    ...
    "Ничто не доставляет такого же удовольствия для моего мужа " +
...
exports.italianText = "Roma è un comune italiano, capitale della Repubblica Italiana, " +
    "nonché capoluogo dell'omonima città metropolitana e della regione Lazio.";
exports.easyArabicText = "ذهب هند وأحمد الى المدرسة. هند تحب الرسم والمطالعة";
exports.hardArabicText = "\u062a\u062a\u0631\u0643\u0632 \u0623\u0633\u0633 " +
    "\u0627\u0644\u0641\u064a\u0632\u064a\u0627\u0621 " +
    "\u0627\u0644\u0646\u0648\u0648\u064a\u0629 \u0628\u0634\u0643\u0644 " +
    "\u0639\u0627\u0645 \u0639\u0644\u064a \u0627\u0644\u0630\u0631\u0629 " +
    "\u0648\u0645\u0643\u0648\u0646\u0627\u062a\u0647\u0627 " +
    ...
    "\u0648\u062a\u0641\u0627\u0639\u0644\u0627\u062a\u0647\u0627 " +
    "\u0627\u0644\u0645\u062e\u062a\u0644\u0641\u0629";
exports.testSyllableCountCases = [
    ["en", exports.shortTest, 7, 0],
    ["en", exports.punctText, 74, 3],
    ["en", "faeries", 2, 1],
    ["en", "relived", 2, 0],
    ["en", "couple", 2, 0],
    ["en", "enriched", 2, 0],
